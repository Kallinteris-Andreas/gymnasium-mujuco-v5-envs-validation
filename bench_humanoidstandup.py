...
from envs import humanoidstandup_v5
import numpy as np
...
for run in range(0, RUNS):
    ...
    eval_env = gym.wrappers.TimeLimit(humanoidstandup_v5.HumanoidStandupEnv(), max_episode_steps=1000)

    #eval_path = 'results/HumanoidStandup_v4_PPO/run_' + str(run)
    eval_path = 'results/HumanoidStandup_v5_PPO/run_' + str(run)

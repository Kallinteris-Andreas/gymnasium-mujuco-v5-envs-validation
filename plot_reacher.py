...
ax.set_title('TD3 on MuJoCo/Reacher, for ' + str(RUNS) + ' Runs')
ax.legend()

fig.set_figwidth(16)
fig.set_figheight(9)

plt.savefig("figures/TD3_Reacher" + ".eps", bbox_inches="tight")
plt.savefig("figures/TD3_Reacher" + ".png", bbox_inches="tight")

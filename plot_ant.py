...
returns_SAC_v5_wo_ctn = np.average(np.array([np.load('results/ant_v5_without_ctn_SAC/run_' + str(run) + '/evaluations.npz')['results'] for run in range(RUNS)]), axis=2)
...
returns_SAC_v4_w_ctn_len = np.average(np.array([np.load('results/ant_v4_fixed_with_ctn_SAC/run_' + str(run) + '/evaluations.npz')['ep_lengths'] for run in range(RUNS)]), axis=2)
returns_SAC_v4_wo_ctn_len = np.average(np.array([np.load('results/ant_v4_fixed_without_ctn_SAC/run_' + str(run) + '/evaluations.npz')['ep_lengths'] for run in range(RUNS)]), axis=2)
...
##ax.plot(steps, np.average(returns_TD3_v4_wo_ctn, axis=0), label='v4 (fixed reward) without ctn (TD3)')
...
ax.plot(steps, np.average(returns_TD3_v5_wo_ctn, axis=0), label='v5 without ctn (TD3)')
ax.fill_between(steps, np.min(returns_TD3_v5_wo_ctn, axis=0), np.max(returns_TD3_v5_wo_ctn, axis=0), alpha=0.2)
...
ax.plot(steps, np.average(returns_SAC_v5_wo_ctn, axis=0), label='v5 without ctn (SAC)')
ax.fill_between(steps, np.min(returns_SAC_v5_wo_ctn, axis=0), np.max(returns_SAC_v5_wo_ctn, axis=0), alpha=0.2)
...
##ax.plot(steps, np.average(returns_TD3_v4_wo_ctn_len, axis=0), label='v4 (fixed reward) without ctn (TD3)')
...
ax.plot(steps, np.average(returns_TD3_v5_wo_ctn_len, axis=0), label='v5 without ctn (TD3)')
ax.fill_between(steps, np.min(returns_TD3_v5_wo_ctn_len, axis=0), np.max(returns_TD3_v5_wo_ctn_len, axis=0), alpha=0.2)
...
ax.plot(steps, np.average(returns_SAC_v5_wo_ctn_len, axis=0), label='v5 without ctn (SAC)')
ax.fill_between(steps, np.min(returns_SAC_v5_wo_ctn_len, axis=0), np.max(returns_SAC_v5_wo_ctn_len, axis=0), alpha=0.2)

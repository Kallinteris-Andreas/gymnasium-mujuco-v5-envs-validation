...
ax.plot(steps, np.average(returns_TD3_v5a_w_ctn, axis=0), label='v5 (alpha) with ctn')
...
fig = plt.figure()
ax = fig.add_subplot(1, 1, 1)
ax.plot(steps, np.average(returns_TD3_v4_w_ctn_len, axis=0), label='v4 (fixed reward) with ctn')
ax.plot(steps, np.average(returns_TD3_v4_wo_ctn_len, axis=0), label='v4 (fixed reward)/v5 without ctn')
ax.plot(steps, np.average(returns_TD3_v5a_w_ctn_len, axis=0), label='v5 (alpha) with ctn')
ax.plot(steps, np.average(returns_TD3_v5_w_ctn_len, axis=0), label='v5 with ctn')
